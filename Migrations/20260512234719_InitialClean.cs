        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoComentario = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroComentario = table.Column<int>(type: "int", nullable: false),
                    Usuario = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KaizenComentarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KaizenComentarios_KaizenIdeas_IdeaId",
                        column: x => x.IdeaId,
                        principalTable: "KaizenIdeas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KaizenComentarios_IdeaId",
                table: "KaizenComentarios",
                column: "IdeaId");
